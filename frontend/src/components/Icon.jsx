  ...
  const icons = {
    ...
    play: (
      <svg
        ...
        stroke="none"
      >
        <path d="M8 5.14v13.72a1 1 0 0 0 1.53.85l10.73-6.86a1 1 0 0 0 0-1.7L9.53 4.29A1 1 0 0 0 8 5.14z" />
      </svg>
    ),
    settings: (
      <svg
      ...
      >
        ...
        <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09a1.65 1.65 0 0 0-1-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.6 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 8.92 4.6H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9c.36.49.56 1.08.57 1.69V11a1.65 1.65 0 0 0 1.51 1H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" />
      </svg>
    ),
    sun: (
      <svg
    ...
    moon: (
      <svg
        ...
        strokeWidth="2"
      >
        <path d="M21 12.79A9 9 0 1 1 11.21 3c0 5.24 4.25 9.49 9.49 9.79z" />
      </svg>
    ),
  };
...
export function FormatToolbarIcon({ type }) {
  ...
  const icons = {
    bold: (
      <span className="format-toolbar-glyph format-toolbar-glyph-bold">B</span>
    ),
    italic: (
      <span className="format-toolbar-glyph format-toolbar-glyph-italic">
        I
      </span>
    ),
    heading1: (
      <span className="format-toolbar-glyph format-toolbar-glyph-heading">
        H1
      </span>
    ),
    heading2: (
    ...
    quote: (
      <svg width={size} height={size} viewBox="0 0 16 16" aria-hidden="true">
        <path
          d="M5.5 4.5H3.8c-.9 0-1.6.7-1.6 1.6v1.2c0 .9.7 1.6 1.6 1.6h1.1v2.6"
          {...stroke}
        />
        <path
          d="M11.8 4.5h-1.7c-.9 0-1.6.7-1.6 1.6v1.2c0 .9.7 1.6 1.6 1.6h1.1v2.6"
          {...stroke}
        />
      </svg>
    ),
    ...
    link: (
      <svg width={size} height={size} viewBox="0 0 16 16" aria-hidden="true">
        <path
          d="M6.2 9.8 4.4 11.6a2.1 2.1 0 1 1-3-3L3.7 6.3a2.1 2.1 0 0 1 3 0"
          {...stroke}
        />
        <path
          d="M9.8 6.2 11.6 4.4a2.1 2.1 0 1 1 3 3L12.3 9.7a2.1 2.1 0 0 1-3 0"
          {...stroke}
        />
    ...
    hr: (
      <svg width={size} height={size} viewBox="0 0 16 16" aria-hidden="true">
        <line x1="2" y1="8" x2="14" y2="8" strokeWidth="2" {...stroke} />
        <line x1="2" y1="5" x2="2" y2="11" {...stroke} />
